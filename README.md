...
Libraries were both installed on computer and locally built in project, a list of key ones is below but the rest will have to be installed through trial and error
(or knowledge if your someone who knows more than me)

- SFML 2.6.1
- TGUI 1.6.1
- Candle
- curlpp 0.8.1
- imgui and imgui-sfml 2.6.1
- portaudio
- rapid json

  All assets have either been made by me or bought at the respective links:
